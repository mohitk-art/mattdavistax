...
<head>
    ...
    <link href="{{ url('assets/css/light-bootstrap.css?v=1.4.0') }}" rel="stylesheet"/>
    <link href="{{ url('assets/css/pe-icon-7-stroke.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/app.css') }}" rel="stylesheet">
    <link href="{{ url('assets/css/demo1.css') }}" rel="stylesheet" />
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                              ...
                              <li><a href="{{url('show_user',base64_encode(Auth::user()->id))}}">Profile Setting</a></li>
