...
<section class="services py-5 text-center" id="about">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-10 mx-auto col-md-6 col-lg-3 my-3">
                <span class="service-icon">
                    <i class="fa fa-money fa-3x fab"></i>
                </span>
                <h5 class="font-weight-bold text-uppercase">
                    Maximum Refund
                </h5>
            ...
            <div class="col-10 mx-auto col-md-6 col-lg-3 my-3">
                <span class="service-icon">
                    <i class="fa fa-life-ring fa-3x fab"></i>
                </span>
                <h5 class="font-weight-bold text-uppercase">
                    Audit Support
                </h5>
            ...
            <div class="col-10 mx-auto col-md-6 col-lg-3 my-3">
                <span class="service-icon">
                    <i class="fa fa-percent fa-3x fab"></i>
                </span>
                <h5 class="font-weight-bold text-uppercase">
                  100% Accuracy
                </h5>
            ...
            <div class="col-md-6 mr-top">
             ...
             <div class="col-md-6 mr-top">
                <div class="shadow box-text">
                     ...
                     <hr />
                     <p style="text-align: initial;">We’re so certain you’ll be satisfied with the tax preparation services at our offices, you only pay us if you accept your return.*
*By authorizing us to e-file your tax return or by taking the completed return to file, you are accepting the return and are obligated to pay all fees when due.</p>
             ...
             <div class="col-md-6 mr-top align">
                <div class="shadow box-text">
                     ...
                     <hr />
                     <p style="text-align: initial;">If you receive an IRS or other tax notice related to the return you filed with us we will help you understand it and give you steps to take to respond at no additional charge.*</p>
                     <p>*Does not include in-person audit representation or assistance in responding, which is sold separately. We do not provide legal advice.</p>
                </div>
            </div>
